  ...
  return (
    <div className=" pt-4 lg:pt-0 lg:pb-20  w-[90%] m-auto text-headerGrey">
      ...
      <div className="lg:hidden p-2 my-6 flex gap-4 items-center border-roundedGrey border-2 w-[40%] justify-center rounded-full m-auto">
        <button
          className={`${prop.prevBtn} border-2 w-[40px] h-[40px] inline-flex justify-center items-center rounded-full border-roundedGrey bg-lightDark`}
        >
          <svg
            width="10"
            height="16"
        ...
        <button
          className={`${prop.nextBtn} border-2 w-[40px] h-[40px] inline-flex justify-center items-center rounded-full border-roundedGrey bg-lightDark`}
        >
          <svg
            width="10"
            height="16"
