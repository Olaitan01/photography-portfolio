...
function Footer() {
  return (
    ...
    <div className="border-r-2 border-l-2 border-lightDark ">
     <div >
        <div className="px-4 border-b-2 border-lightDark pb-8">
            ...
            <div className="mt-6">
              ...
              <div >
               ...
               <div>
                ...
                <div className="text-sm py-8 font-normal text-grey text-center border-t-2 border-lightDark ">
                    ...
                    <div className="p-2  flex gap-2 items-center border-roundedGrey border-2 w-[40%] justify-center rounded-full m-auto">
